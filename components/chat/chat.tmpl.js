...
var pug_match_html=/["&<>]/;
function pug_rethrow(n,e,r,t){if(!(n instanceof Error))throw n;if(!("undefined"==typeof window&&e||t))throw n.message+=" on line "+r,n;try{t=t||require("fs").readFileSync(e,"utf8")}catch(e){pug_rethrow(n,null,r)}var i=3,a=t.split("\n"),o=Math.max(r-i,0),h=Math.min(a.length,r+i),i=a.slice(o,h).map(function(n,e){var t=e+o+1;return(t==r?"  > ":"    ")+t+"| "+n}).join("\n");throw n.path=e,n.message=(e||"Pug")+":"+r+"\n"+i+"\n\n"+n.message,n}function chatTmpl(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {var pug_debug_sources = {"components\u002Fchat\u002Fchat.tmpl.pug":"h1.chat__header='добро пожаловать ' + (user || '')\r\ndiv.chat__content\r\n    ul.chat__list\r\n        if !messages.length\r\n            h3.cfont Нет сообщений\r\n        each message in messages\r\n            li.chat__item(class=message.isMine ? 'right-img' : 'left-img')\r\n                .chat__item__avatar\r\n                    img(src=message.img)\r\n                .chat__item__header.clearfix\r\n                    span.chat__item__autor=message.username\r\n                    span.chat__item__data=message.data\r\n                .chat__item__message=message.message"};
;var locals_for_with = (locals || {});(function (messages, user) {;pug_debug_line = 1;pug_debug_filename = "components\u002Fchat\u002Fchat.tmpl.pug";
pug_html = pug_html + "\u003Ch1 class=\"chat__header\"\u003E";
;pug_debug_line = 1;pug_debug_filename = "components\u002Fchat\u002Fchat.tmpl.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = 'добро пожаловать ' + (user || '')) ? "" : pug_interp)) + "\u003C\u002Fh1\u003E";
;pug_debug_line = 2;pug_debug_filename = "components\u002Fchat\u002Fchat.tmpl.pug";
pug_html = pug_html + "\u003Cdiv class=\"chat__content\"\u003E";
...
pug_html = pug_html + "\u003Cli" + (pug_attr("class", pug_classes(["chat__item",message.isMine ? 'right-img' : 'left-img'], [false,true]), false, false)) + "\u003E";
...
pug_html = pug_html + "\u003C\u002Ful\u003E\u003C\u002Fdiv\u003E";}.call(this,"messages" in locals_for_with?locals_for_with.messages:typeof messages!=="undefined"?messages:undefined,"user" in locals_for_with?locals_for_with.user:typeof user!=="undefined"?user:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line, pug_debug_sources[pug_debug_filename]);};return pug_html;}